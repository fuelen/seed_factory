          ...
          try do
            ...
            {:conflict, _v1, _v2, _path} ->
              if args_match.(acc) do
                ...
                raise ArgumentError, """
                Cannot apply trait #{inspect(trait.name)} of entity #{inspect(trait.entity)} for command #{inspect(trait.exec_step.command_name)}.
                Generated args: #{inspect(acc)}
                Probably, arguments generated by :generate_args don't match :args_match function.
                """
              end
          end
      end
